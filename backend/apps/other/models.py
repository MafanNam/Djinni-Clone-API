...
from apps.core.services import get_path_upload_image_company, validate_file_size
...
class Company(TimeStampedModel):
    ...
    image = models.ImageField(upload_to=get_path_upload_image_company, validators=[validate_file_size])
